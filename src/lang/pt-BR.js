...
export function isVideo_metadata(text) {
	return (
		text.includes('visualizaç') && // visualização, visualizações
...
export function isNotificationOff_button(text) {
	return text === 'Receber notificações' || text === 'Receber notificação';
}
