...
export function isScheduled_metadata(text) {
	return text.includes('Geplant') || text.includes('Premiere');
}
...
export function isNotificationOff_button(text) {
	return text === 'Benachrichtigung aktivieren' || text === 'Benachrichtigung erhalten';
}
