...
export function isVideo_metadata(text) {
	return (
		text.includes('visionnement') && // visionnements
...
export function isNotificationOff_button(text) {
	return text === 'Me prévenir' || text === "M'informer";
}
